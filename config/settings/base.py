...
# Now replace the hardcoded keys with variables from .env
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"], # Path to moved templates folder
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.core.context_processors.site_settings", # ADD THIS LINE
            ],
        },
    },
]
